...
class ProductService {
    ...
    addProductV2 = async (req, res) => {
        ...
        try {
            ...
            const cloudinaryFolderName = 'NodeJS_FinalProject/products/pcs';
            let image_link = '';
        ...
        try {
            ...
            if (product.product_img) {
                try {
                    ...
                    //delete old image
                    await cloudinary.uploader.destroy('NodeJS_FinalProject/products/pcs/' + publicId).then(result => { console.log(result) }).catch(error => { console.log(error) });
                } catch (err) {
