            ...
            <div className="shop-filter col-lg-3 col-md-4 col-sm-12">
                <div className="shop-filter__department">
                    ...
                    <ul className="shop-filter__department-list p-0">
                        ...
                        <li data-filter=".pc" className="shop-filter__department-item d-flex">
                            <div
                                onClick={() => setItemType('PC')}
                                className={clsx(styles['shop-filter__department-item__para'], 'link-underline', `${itemType === 'PC' && styles['link-department']}`)}>PC</div>
                        </li>
                        ...
                        <li data-filter=".screen" className="shop-filter__department-item d-flex">
                            <div
                                onClick={() => setItemType('Screen')}
                                className={clsx(styles['shop-filter__department-item__para'], 'link-underline', `${itemType === 'Screen' && styles['link-department']}`)}>Screen</div>
                        </li>
                    </ul>
                </div>
