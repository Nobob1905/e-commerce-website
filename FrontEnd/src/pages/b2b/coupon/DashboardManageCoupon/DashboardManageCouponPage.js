    ...
    return (
        <>
                                ...
                                <table className="table table-hover table-bordered">
                                    ...
                                    {currentItems.map((item, index) => (
                                        <tr key={`coupon-${index}`}>
                                            ...
                                            <td>
                                                <p className={clsx(styles['user-table__text'])}>{item.maxUsage}</p>
                                            </td>
                                            <td>
                                                <p className={clsx(styles['user-table__text'])}>{item.usedCount}</p>
                                            </td>
                                            <td>
            ...
            <Modal
                ...
                isStatic={true}
                saveClassName={clsx(styles['edit-modal__save'], 'btn btn-successr')}
            >
                <div className="form-group">
                    ...
                    <div className="form-group">
                        <label className={clsx(styles['edit-modal__label'], 'mt-0')} htmlFor="code-edit">COUPON CODE</label>
                    ...
                    <div className="form-group">
                        <label className={clsx(styles['edit-modal__label'])} htmlFor="maxUsage-edit">MAX USAGE</label>
                        <input onChange={e => dispatch(onChangeData({maxUsage: e.target.value}))}
                            type="number"
                            id='maxUsage-edit'
                    ...
                    <div className="form-group">
                        <label className={clsx(styles['edit-modal__label'])} htmlFor="usedCount-edit">USED COUNT</label>
                        <input onChange={e => dispatch(onChangeData({usedCount: e.target.value}))}
                            type="number"
                            id='usedCount-edit'
            ...
            >
                <div className="form-group">
                    ...
                    <div className="form-group">
                        <label className={clsx(styles['edit-modal__label'], 'mt-0')} htmlFor="code-add">COUPON CODE</label>
                        <input onChange={e => dispatch(onChangeData({code: e.target.value}))}
                            type="text"
                            id='code-add'
                            placeholder='Enter coupon code'
                    ...
                    <div className="form-group">
                        <label className={clsx(styles['edit-modal__label'])} htmlFor="maxUsage-add">MAX USAGE</label>
                        <input onChange={e => dispatch(onChangeData({maxUsage: e.target.value}))}
                            type="number"
                            id='maxUsage-add'
                            placeholder='Enter max usage'
                    ...
                    <div className="form-group">
                        <label className={clsx(styles['edit-modal__label'])} htmlFor="usedCount-add">USED COUNT</label>
                        <input onChange={e => dispatch(onChangeData({usedCount: e.target.value}))}
                            type="number"
                            id='usedCount-add'
                            placeholder='Enter used count'
            ...
            <Modal
                ...
                isStatic={true}
                saveClassName={clsx(styles['delete-modal__save'], 'btn btn-successr')}
            >
