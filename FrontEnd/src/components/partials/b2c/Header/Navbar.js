                    ...
                    <div className="row w-100">
                        <div className="header-top__left d-flex col-lg-6 col-sm-6 col-md-6">
                            <div className="header-top__left-email d-flex align-items-center">
                                ...
                                <a href="mailto:thanhcongzxc456@gmail.com"
                                   className={clsx('ml-5 mr-15', styles['header-top__left-email--mail'])}>thanhcongzxc456@gmail.com</a>
                            </div>
                            ...
                            <div className="header-top__left-para d-flex align-items-center col-md-0 col-sm-0">
                                ...
                                <p className="header-top__left-info mb-0 ml-15">ThongThichNgu Shopping Center</p>
                            </div>
                        </div>
                        <div
                        ...
                        <div className="col-lg-4 col-sm-6 col-md-1 d-flex">
                            ...
                            <div className={clsx("header-bottom__contact col-sm-0 d-flex col-lg-8 col-md-0 col-sm-8")}>
                                ...
                                <div className="header-bottom__text">
                                    <a className={clsx(styles['header-bottom__link-phone'])} href="tel:+84356773698">0706873698</a>
                                    <p className={clsx('mb-0')}>support 24/7</p>
                                </div>
                            </div>
                        ...
                        <div className={clsx("col-lg-2 col-md-3 col-sm-12 position-relative", stylesGrid['header-search__category'])}>
                            ...
                            <div style={{zIndex: 3}} className={clsx("position-absolute header-search__left-list", styles['header-search__left-list'])}>
                                <div className={clsx(styles['header-search__left-list--inner'], isCategoryClicked ? styles['header-search__left-list--down']: undefined)}>
                                    <div className={clsx(styles['header-search__left-item'])}>PC</div>
                                    ...
                                    <div className={clsx(styles['header-search__left-item'])}>Screen</div>
                        ...
                        <div className="col-lg-8 col-md-7 col-sm-12 d-flex position-relative">
                            <div className="col-lg-12 col-sm-12 col-md-12 d-flex align-items-center">
                                <input value={search} onChange={e => setSearch(e.target.value)}
                                       ...
                                       id=""/>
                                <Button label="SEARCH"
                                        className={clsx('btn btn-successr col-lg-2 col-md-3 col-sm-3', styles['header-search__middle-btn'])}/>
                            </div>
                            ...
                            <div className="login-form col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div className="form-group mt-3">
                                    <div className="form-group">
                                        <label htmlFor="email" className="login-modal__email"><p className="mb-0">Email</p></label>
                                        <input name='email' onChange={(e) => handleLogInformation({email: e.target.value})} type="email" id="email" placeholder='Enter email...'
