                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5 col-md-6 col-sm-6">
                            <h4>Contact Us</h4>
                            <p className={clsx(styles["footer-top__st-contact"])}>Address: 29 Tan An, Tan Binh, 
                                Chau Thanh</p>
                            <p className={clsx(styles["footer-top__st-contact"])}>Phone: <a
                                href="tel:+84356773698">0706873698</a></p>
                            <p className={clsx(styles["footer-top__st-contact"], 'mb-0')}>Email: <a
                                href="mailto:thanhcongzxc456@gmail.com">thanhcongzxc456@gmail.com</a></p>
                        </div>
